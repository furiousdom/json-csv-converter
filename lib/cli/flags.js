...
module.exports = {
  ...
  keepEmptyRows: { alias: 'k', type: 'boolean', demandOption: false, describe: 'Preserve empty rows (used with NDJSON).' },
  ...
  setPropValues: { alias: 'v', type: 'array', demandOption: false, describe: 'Enter the properties and values to set them to.' }
};
