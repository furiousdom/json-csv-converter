...
function unwind(data, options) {
  const flatten = (obj, accumulator, propPath) => {
    Object.keys(obj).forEach(key => {
      ...
      const value = getNewValue(newPropPath, obj[key], options);
